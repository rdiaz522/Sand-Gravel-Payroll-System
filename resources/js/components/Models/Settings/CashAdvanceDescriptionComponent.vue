    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="form-group">
                <AppTextBox label="Cash Advance Description" v-model="formData.name" placeholder="Enter Cash Advance Description ..."> </AppTextBox>
            </div>
...
export default {
    ...
    methods: {
        save() {
            this.$SHOW_LOADING();
            axios.post(this.$BASE_URL + this.$CASHADVANCEDESCRIPTION, this.formData)
                .then((response) => {
                    this.clearFields();
                    this.$HIDE_LOADING();
                    this.$SHOW_MESSAGE('Successfully', 'New Cash Description Added!', 'success');
                })
                .catch((error) => {
                    this.$HIDE_LOADING();
